...
# ---- LB2004: RK809 PMIC vdd_npu (DCDC_REG4 reg 0xC4) -> 0.9V ----
# Same hack as z96a: without this the vdd_npu rail sits at 0.5V from
# reset and high-frequency operation is unstable (garbage on serial,
# spontaneous reboots when scaling to 1.8GHz).
echo "lb2004-uboot: setting vdd_npu (DCDC_REG4 reg 0xC4) to 900mV"
if i2c dev 0; then
	if i2c probe 20; then
		echo "lb2004-uboot: PMIC found on bus 0, reg C4 before:"
		i2c md 20 C4 1
		i2c mw 20 C4 20
		echo "lb2004-uboot: bus 0 written, reg C4 after:"
		i2c md 20 C4 1
	fi
fi
if i2c dev 1; then
	if i2c probe 20; then
		echo "lb2004-uboot: PMIC found on bus 1, reg C4 before:"
		i2c md 20 C4 1
		i2c mw 20 C4 20
		echo "lb2004-uboot: bus 1 written, reg C4 after:"
		i2c md 20 C4 1
	fi
fi
